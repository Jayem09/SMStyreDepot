...
if (!orderId) {
    ...
    console.error('Usage: node scripts/create_fake_webhook.js <order_id>');
    process.exit(1);
}
...
console.log(`🔹 Simulating PayMongo Webhook for Order #${orderId}...`);
...
console.log(`🔹 Generated Signature Header: ${header}`);
